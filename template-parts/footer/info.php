...
$contact_us_phone			= get_field('contact_us_phone');
			...
			$facebook_img			= get_field('facebook_img');
			$instagram_link			= get_field('instagram_link');
			$instagram_img			= get_field('instagram_img');
			$linkedin_link			= get_field('linkedin_link');
			$linkedin_img			= get_field('linkedin_img');
...
<div class="blockTitle">
	...
	<div id="socialIcons">
		<div id="socialIcon1">
			...
			<amp-img
				src="<?php echo $facebook_img['url']; ?>"
				width="1"
				height="1"
				layout="responsive"
				alt="<?php echo $facebook_img['alt']; ?>">
			</amp-img>
</a>
		</div>
		<div id="socialIcon2">
		<a href="<?php echo $instagram_link; ?>" rel="noopener" target="_blank">
			<amp-img
				src="<?php echo $instagram_img['url']; ?>"
				width="1"
				height="1"
				layout="responsive"
				alt="<?php echo $instagram_img['alt']; ?>">
			</amp-img>
</a>
		</div>
		<div id="socialIcon3">
		<a href="<?php echo $linkedin_link; ?>" rel="noopener" target="_blank">
			<amp-img
				src="<?php echo $linkedin_img['url']; ?>"
				width="1"
				height="1"
				layout="responsive"
				alt="<?php echo $linkedin_img['alt']; ?>">
			</amp-img>
</a>
		</div>
</div>
